...
def test_one_compnay_exists_should_succeed(client) -> None:
...
# ------- Test Post Companies------------
def test_create_company_without_arguments_should_fali(client) -> None:
...
def test_create_company_with_only_name_all_fields_should_be_default(client) -> None:
    ...
    assert response_content.get("status") == "Hiring"
    assert response_content.get("applicatetion_link") == None
    assert response_content.get("notes") == ""
