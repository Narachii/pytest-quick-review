...
class TestGetCompanies(BasicCompanyApiTestCase):
    ...
    def test_one_compnay_exists_should_succeed(self) -> None:
        ...
        self.assertEqual(response_content.get("applicatetion_link"), None)
...
class TestPostCompanies(BasicCompanyApiTestCase):
    def test_create_company_without_arguments_should_fali(self) -> None:
